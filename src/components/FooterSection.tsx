...
function FooterSection() {
  const handleCode = useExternalLink("https://github.com/shivaKotagiri/dukaan-ui");
  ...
  return (
    <div className="justify-center flex-col w-full p-5">
      <div className="text-gray-500 text-center">
        --- Made By
        <span onClick={handleFun} className="text-[#146fb5] font-semibold cursor-pointer"> Shiva Kumar Kotagiri</span>, inspired by
