    ...
    <div className="container mx-auto bg-white">
      <div className="grid grid-cols-1 md:grid-cols-3 items-center">
        <div className="flex items-center justify-center md:justify-start py-4">
          ...
          <small className="ml-1.5 mt-1">
            <small className="text-[12px]">How it works</small>
          </small>
        </div>
        <div className="py-3 md:py-0 w-full md:w-auto order-3 md:order-2 mb-4 md:mb-0">
          <form className="w-full md:max-w-sm mx-auto">
            ...
            <div className="relative">
              ...
              <input type="search" id="default-search" className="block w-full p-2 ps-10 text-md text-gray-900 rounded-sm bg-[#F2F2F2] focus:outline-none" placeholder="Search features, tutorials, etc." required />
            </div>
          </form>
        </div>
        <div className="flex h-10 justify-center md:justify-end md:ml-auto pb-3 order-2 md:order-3 mb-4 md:mb-0">
          <div className="rounded-full bg-[#E6E6E6] h-10 w-10 items-center justify-center flex mr-4 cursor-pointer">
          ...
          <div className="rounded-full bg-[#E6E6E6] h-10 w-10 items-center justify-center flex cursor-pointer">
